...
final fakeResponseModel = ResponseModel(
  title: 'Fake Title',
  description: 'Fake Description',
  content: 'fake content Fake Content',
  url: 'fakeUrl.com',
  image: 'fakeImage.jpeg',
  publishedAt: 'October',
  sourceName: 'Fake Times',
);

final Map<String, dynamic> gNewsResponseJson = {
  "totalArticles": 54904,
  "articles": [
    {
      "title":
      ...
      "source": {"name": "PhoneArena", "url": "https://www.phonearena.com"}
    }
  ]
};
